...
async function seed() {
  ...
  const reviews = await Promise.all([
    ...
    Review.create({title: 'Favorite Candy!!', description: 'My favorite candy of all time and I have so much of it! Not sure how long it will last though.', productId:  1, userId: 1}),
    Review.create({title: 'Big Surprise', description: 'A friend of mine loves this candy. I bought this huge bag of them and placed it in a large tin for Christmas. They loved it!', productId:  1, userId: 3}),
    Review.create({title: 'Good Quality!', description: 'Quick delivery. Great price. Soft and chewy. Didn’t last long in our house!', productId:  3, userId: 4}),
    Review.create({title: '100% Satisfied', description: 'At first I was very skeptical buying food off here, but it tasted completely fresh', productId:  2, userId: 2})
  ])
